...
import com.example.Gestiondeclientes.Services.StateUsersServices;
...
public class StateUsersController {
    ...
    public ResponseEntity<StateUsersEntity> getStateUsersbyname(@PathVariable String name) {
        StateUsersEntity newstateusers = stateUsersServices.getStateUsersByname(name);
        return ResponseEntity.ok(newstateusers);
    }
