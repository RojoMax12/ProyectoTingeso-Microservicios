...
public class LoanToolsServices {
    ...
    public LoanToolsEntity CreateLoanToolsEntity(LoanToolsEntity loanToolsEntity) {
        ...
        Client client = restTemplate.getForObject("http://Gestióndeclientes/api/Client/" + loanToolsEntity.getClientid(), Client.class);

        StateUsers restrictedState = restTemplate.getForObject("http://Gestióndeclientes/api/stateuser/name/" + "Restricted", StateUsers.class);
        if (client.getState().equals(restrictedState.getId())) {
            throw new IllegalStateException("Cliente en estado restringido");
        }


        Tool currentTool = restTemplate.getForObject("http://GestiónInvdeHerrMicroservices/api/Tool/tool/" + loanToolsEntity.getToolid(), Tool.class );
                ...
                .map(loan -> {
                    try {
                        ...
                        return restTemplate.getForObject(
                                "http://GestiónInvdeHerrMicroservices/api/Tools/tool/" + loan.getToolid(),
                                Tool.class
                        );
                    } catch (Exception e) {
        ...
        Tool herramienta = restTemplate.getForObject("http://GestiónInvdeHerrMicroservices/api/Tools/name/tool/" + loanToolsEntity.getToolid(), Tool.class );

        System.out.println("Herramienta encontrada: " + herramienta);

        // 6. Validar estados
        System.out.println("Obteniendo estados de herramientas");
        StateTools[] statetools = restTemplate.getForObject("http://GestiónInvdeHerrMicroservices/api/statetools/", StateTools[].class);
        ...
        try {
            ...
            restTemplate.put("http://GestiónInvdeHerrMicroservices/api/tools/UpdateTool", herramienta);
    ...
    public LoanToolsEntity returnLoanTools(Long userid, Long toolid) {
        // Buscar herramienta
        Tool tool = restTemplate.getForObject("http://GestiónInvdeHerrMicroservices/api/Tools/name/tool/" + toolid, Tool.class );
        ...
        restTemplate.put("http://GestiónInvdeHerrMicroservices/api/Tools/UpdateTool", tool);
    ...
    public boolean checkAndUpdateClientStatus(Long clientId) {
        ...
        Client client = restTemplate.getForObject("http://Gestióndeclientes/api/Client/" + clientId, Client.class);


        System.out.println("[TRACE] Cliente encontrado: " + client.getId() + ", estado actual: " + client.getState());

        // Obtener estados
        Long restricted = restTemplate.getForObject("http://Gestióndeclientes/api/stateuser/name/" + "Restricted", StateUsers.class).getId();
        Long active = restTemplate.getForObject("http://Gestióndeclientes/api/stateuser/name/" + "Active", StateUsers.class).getId();
    ...
    public void registerDamageFeeandReposition(Long loanId) {
        ...
        Tool tool = restTemplate.getForObject("http://GestiónInvdeHerrMicroservices/api/Tool/tool/" + loan.getToolid(), Tool.class );

        Amountsandrates rates = restTemplate.getForObject("http://GestióndemontytarMicroservices/api/AmountandRates/" + 1L, Amountsandrates.class);
